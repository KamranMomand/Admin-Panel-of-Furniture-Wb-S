            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box table-responsive">
                        <h4 class="header-title">Wedding Package Details</h4>
                        <br>
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive "
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['wpack_img1']); ?>"
                                            width="100px" height="100px" /></td>
                                    <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['wpack_img2']); ?>"
                                            width="100px" height="100px" /></td>
                                    <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['wpack_img3']); ?>"
                                            width="100px" height="100px" /></td>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <br />
                            <input type="submit" class="btn btn-primary" value="Add WeddingPackage" id="btnAddd" name="btnAddd" />
                        </form>
                    </div>
                </div>
            </div>
