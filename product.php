                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive "
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['pro_crossprice']; ?></td>
                                    <td><?php echo $row['pro_quantity']; ?></td>
                                    <td><?php echo $row['pro_subcat']; ?></td>
                                    <td><?php echo $row['pro_badge']; ?></td>
                                    <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['pro_img1']); ?>"
                                            width="100px" height="100px" /></td>
                                    <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['pro_img2']); ?>"
                                            width="100px" height="100px" /></td>
                                    <td><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['pro_img3']); ?>"
                                            width="100px" height="100px" /></td>
                                    <td><?php echo $row['pro_video']; ?></td>
                                    <td><?php echo $row['pro_warranty']; ?></td>
                                    <td><?php echo $row['pro_featured']; ?></td>
                                    <td><?php echo $row['pro_status']; ?></td>
                                    <td><a href="products_delete.php?id=<?php echo $row['pro_id']; ?>"
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <br>
                            <input type="submit" class="btn btn-primary" value="Add Product" id="btnAddd"
                                name="btnAddd" />
                        </form>
                    </div>
                </div>
