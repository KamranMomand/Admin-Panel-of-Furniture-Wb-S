...
{
    $id=$_GET['id'];
    $s_query="SELECT * FROM `wedding_packages` WHERE wpack_id='$id'";
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <select class="form-control" name="warrenty">
                                <option>Select Product Warrenty</option>
                                <?php
                            ...
                            <br />
                            <select class="form-control" name="status" value="<?php echo $s_row['wpack_status']?>">
                            ...
                            <br>
                            <input type="submit" class="btn btn-primary" value="Update WeddingPackage" name="btnEdit" />
                        </form>
